...
public class ExternalServicesRequestOLD {

	private static final Logger LOGGER = LoggerFactory.getLogger(ExternalServicesRequestOLD.class);
	...
	private static ExternalServicesRequestOLD instance = null;
	...
	public static ExternalServicesRequestOLD getInstance() {
		if (instance == null) {
			instance = new ExternalServicesRequestOLD();
